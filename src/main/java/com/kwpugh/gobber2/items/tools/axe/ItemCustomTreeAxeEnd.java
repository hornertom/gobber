...
public class ItemCustomTreeAxeEnd extends AxeItem
{
	public static final Set<Block> EFFECTIVE_ON = Sets.newHashSet(Blocks.OAK_PLANKS, Blocks.SPRUCE_PLANKS, Blocks.BIRCH_PLANKS, Blocks.JUNGLE_PLANKS,
			...
			Blocks.DARK_OAK_LOG, Blocks.CHEST, Blocks.PUMPKIN, Blocks.CARVED_PUMPKIN, Blocks.JACK_O_LANTERN, Blocks.MELON, Blocks.LADDER, Blocks.SCAFFOLDING,
			Blocks.OAK_BUTTON, Blocks.SPRUCE_BUTTON, Blocks.BIRCH_BUTTON, Blocks.JUNGLE_BUTTON, Blocks.DARK_OAK_BUTTON, Blocks.ACACIA_BUTTON,
			Blocks.OAK_PRESSURE_PLATE, Blocks.SPRUCE_PRESSURE_PLATE, Blocks.BIRCH_PRESSURE_PLATE, Blocks.JUNGLE_PRESSURE_PLATE, Blocks.DARK_OAK_PRESSURE_PLATE,
	...
	public ItemCustomTreeAxeEnd(Tier tier, float attackDamageIn, float attackSpeedIn, Properties builder)
	{
	...
	private boolean attemptFellTree(Level world, BlockPos pos, Player player)
	{
		...
		for (int i = 0; i < candidates.size(); i++)
		{
			...
			if (BlockTags.LEAVES.contains(block) || block.equals(Blocks.NETHER_WART_BLOCK) || block.equals(Blocks.WARPED_WART_BLOCK))
			{
				leaves++;
			}
			else if (logs.size() == 0 || BlockTags.LOGS.contains(block) || block.equals(Blocks.NETHER_WART_BLOCK) || block.equals(Blocks.WARPED_WART_BLOCK))
			{
				logs.add(candidate);
